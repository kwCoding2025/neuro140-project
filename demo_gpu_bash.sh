...
#SBATCH --output=gpu_demo_%j.log
#SBATCH --error=gpu_demo_error_%j.log
#SBATCH --partition=gpu              # Adjust partition as needed
#SBATCH --time=24:00:00              # Time limit (adjust as needed)
#SBATCH --mem=128000                 # Memory requested (in MB)
#SBATCH --gres=gpu:2                 # Request 2 GPUs, if necessary
